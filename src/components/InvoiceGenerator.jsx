  ...
  return (
    <div className="max-w-6xl mx-auto p-8 bg-white">
      ...
      <div ref={invoiceRef}>
          ...
          <div className="text-right">
            ...
            <div className="flex flex-col gap-2">
              {previewMode ? (
                ...
                <>
                  {['invoiceNumber', 'invoiceDate', 'dueDate'].map(field => (
                    <div key={field} className="flex items-center justify-end gap-2">
                      ...
                      <input
                        ...
                        placeholder={field === 'invoiceNumber' ? 'Enter number' : ''}
                      />
                    </div>
                  ))}
                </>
        ...
        {/* Invoice Items Table */}
        <div className="mb-4 overflow-x-auto pl-5 pr-5">
          <table className="w-full">
            <thead className="bg-gray-100 mb-2">
              <tr>
                <th className="px-4 py-2 mb-4 text-left">#</th>
                <th className="px-4 py-2 mb-4 text-left">Item Description</th>
            ...
            <tbody>
              {items.map((item, index) => (
                ...
                onChange={handleInputChange}
                className="border rounded px-2 py-1 w-24 mt-2"
        ...
        {/* GST Rate below Invoice Items Table */}
        ...
        <div className="grid grid-cols-2 gap-8 mb-8 pl-5 pr-5">
          <div>
